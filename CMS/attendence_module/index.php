...
<body>
  ...
  <form id="newStudent">
    <input type="text" id="addNewStudent" class="form-control" placeholder="Enter student name">
    <br>
    <button type="submit" class="btn btn-success " >ADD</button>
    <button id='del' class="btn btn-danger" >Delete All</button>
  </form>
  <table>
    <thead>
      <tr>
