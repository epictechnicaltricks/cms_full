...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
	...
	<div class="row justify-content-center align-items-center text-center p-2">
		<div class="m-1 col-sm-8 col-md-6 col-lg-4 shadow-sm p-3 mb-5 bg-white border rounded">
			<div class="pt-5 pb-5">
				<img class="rounded mx-auto d-block" src="../image/teacher.png" alt="" width=70px height=70px>
				<h4 class="text-center text-uppercase mt-3">Teacher Login</h4>
				<form class="form text-center" method="POST" action="">
					<div class="form-group input-group-md">
						<input type="number" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Enter Phone number">
