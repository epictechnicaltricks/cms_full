    ...
    <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md 12">
                    ...
                    <br><br>
                      ...
                      <font color="blue">   <h4>Teacher Dashboard</h4> </font>
                        </center>                    
                    </div>
                   </div>
            </div>
        ...
        <center>
            <a href="../attendence_module/" class="btn btn-success ">Attendance</a>    
                    <a href="../mark_module/mark_add.php" class="btn btn-success ">Marks</a>    
                    <a href="../note_module/note_add.php" class="btn btn-success ">Notes </a>    
